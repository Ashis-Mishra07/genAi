...
export default function CustomerProductsPage() {
  ...
  const [videoModalProduct, setVideoModalProduct] = useState<Product | null>(
    null
  );
              ...
              <div className="text-center py-20">
                ...
                <p className="text-muted-foreground text-lg mb-8 max-w-md mx-auto">
                  {error
                    ...
                    : "No products match your current search and filter criteria. Try adjusting your filters."}
                </p>
                <button
                  onClick={() => {
                    setSearchTerm("");
                    ...
                    <div
                      ...
                      <div
                        ...
                        <div className={viewMode === "list" ? "flex-1" : ""}>
                          <h3 className="font-bold text-card-foreground mb-2 text-lg group-hover:text-primary transition-colors">
                            {product.name}
                          </h3>
                          {product.artisanName && (
                            ...
                            <div className="flex items-center">
                              {[...Array(5)].map((_, i) => {
                                ...
                                const productRating =
                                  product.rating ||
                                  4.2 +
                                    (parseInt(product.id.slice(-1), 16) % 8) *
                                      0.1;
                                return (
                                  <Star
                                    key={i}
                        ...
                        <div
                          ...
                          <button
                            onClick={() =>
                              product.isActive && addToCart(product.id)
                            }
                            className={`${
                              viewMode === "list"
                                ? "px-6 py-3"
                                : "flex-1 py-3 px-4"
                            } rounded-xl font-semibold transition-all transform hover:scale-105 flex items-center justify-center shadow-lg ${
                              product.isActive
                ...
                <div className="flex-1">
                  ...
                  {videoModalProduct.artisanName && (
                    <p className="text-muted-foreground text-sm mb-3">
                      by {videoModalProduct.artisanName}
                    </p>
                  )}
