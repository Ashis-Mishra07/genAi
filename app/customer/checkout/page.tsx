...
import {
  ArrowLeft, CreditCard, MapPin, Package, Shield, CheckCircle, Truck, Clock, AlertCircle, IndianRupee,
} from "lucide-react";
...
export default function CheckoutPage() {
  ...
  async function createAppOrderAfterPayment() {
    const token = localStorage.getItem("auth_token") || localStorage.getItem("accessToken");
        ...
        const rzp = new window.Razorpay({
          ...
          handler: async (response: any) => {
            try {
              ...
              // 4) Create app order as CONFIRMED
              await createAppOrderAfterPayment();
            } catch (e: any) {
