          ...
          <div className="flex items-center space-x-4">
            <div className="flex items-center space-x-3 bg-secondary rounded-xl px-4 py-3">
              ...
              <div className="text-right">
                <p className="text-sm font-medium text-foreground">{customerStats.membershipLevel} Member</p>
                <p className="text-xs text-muted-foreground">{customerStats.loyaltyPoints} points</p>
              </div>
            </div>
          </div>
        </div>
      ...
      <div className="p-6">
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
            ...
            <div className="bg-card rounded-2xl p-6 border border-border shadow-sm">
              ...
              <div className="flex items-center space-x-6 mb-6">
                ...
                <div>
                  ...
                  <p className="text-muted-foreground">Customer since {new Date(profile.joinDate).toLocaleDateString()}</p>
                </div>
              </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                  <label className="block text-sm font-medium text-muted-foreground mb-2">Join Date</label>
                  <div className="flex items-center space-x-3 text-foreground bg-secondary rounded-lg px-4 py-3">
          ...
          <div className="space-y-6">
            {/* Customer Stats */}
            <div className="bg-card rounded-2xl p-6 border border-border shadow-sm">
              <h2 className="text-xl font-semibold text-foreground mb-6">Account Overview</h2>
              ...
              <div className="space-y-4">
                <div className="flex items-center justify-between p-3 bg-secondary rounded-lg">
                  <div className="flex items-center space-x-3">
                    ...
                    <span className="text-foreground font-medium">Total Orders</span>
                  </div>
                  <span className="text-foreground font-semibold">{customerStats.totalOrders}</span>
                </div>
                ...
                <div className="flex items-center justify-between p-3 bg-secondary rounded-lg">
                  <div className="flex items-center space-x-3">
                    ...
                    <span className="text-foreground font-medium">Total Spent</span>
                  </div>
                  <span className="text-foreground font-semibold">₹{customerStats.totalSpent.toLocaleString()}</span>
                </div>
                ...
                <div className="flex items-center justify-between p-3 bg-secondary rounded-lg">
                  <div className="flex items-center space-x-3">
                    ...
                    <span className="text-foreground font-medium">Wishlist Items</span>
                  </div>
                  <span className="text-foreground font-semibold">{customerStats.wishlistItems}</span>
                </div>
                ...
                <div className="flex items-center justify-between p-3 bg-secondary rounded-lg">
                  <div className="flex items-center space-x-3">
                    ...
                    <span className="text-foreground font-medium">Loyalty Points</span>
                  </div>
              ...
              <div className="mt-6 p-4 bg-secondary rounded-xl">
                <div className="flex items-center justify-between">
                  ...
                  <span className={`font-semibold ${
                    customerStats.membershipLevel === 'Gold' ? 'text-yellow-500' :
                    customerStats.membershipLevel === 'Silver' ? 'text-gray-400' : 'text-orange-500'
                  }`}>
                ...
                <div className="mt-3 bg-background rounded-full h-2">
                  <div className={`h-2 rounded-full transition-all ${
                    customerStats.membershipLevel === 'Gold' ? 'bg-yellow-500 w-full' :
                    customerStats.membershipLevel === 'Silver' ? 'bg-gray-400 w-2/3' : 'bg-orange-500 w-1/3'
                  }`}></div>
                </div>
                <p className="text-xs text-muted-foreground mt-2">360 points to Gold level</p>
              </div>
            </div>
            ...
            <div className="bg-card rounded-2xl p-6 border border-border shadow-sm">
              ...
              <div className="space-y-3">
                {recentOrders.map((order) => (
                  <div key={order.id} className="bg-secondary rounded-xl p-4 hover:shadow-sm transition-shadow">
