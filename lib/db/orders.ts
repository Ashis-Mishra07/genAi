...
export async function createOrder(orderData: {
  ...
  try {
    ...
    // Get coordinates from shipping address
    const coordinates = getCoordinatesFromAddress(orderData.shippingAddress);
    
    // Insert order into database with coordinates
    ...
    console.log(`✅ Order ${orderNumber} created with coordinates:`, coordinates || 'No coordinates');
